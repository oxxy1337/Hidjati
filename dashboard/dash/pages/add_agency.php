...
<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" style="margin-left: 20%">
                            <div class="card">
                                <h5 class="card-header">Add new agency</h5>
                                <div class="card-body">
                                    <form enctype="multipart/form-data" action="#" id="basicform" data-parsley-validate="" method="POST">
                                        <div class="form-group">
                                            <label for="inputUserName">Name:</label>
                                            <input id="inputUserName" type="text" name="name" data-parsley-trigger="change" required="" placeholder="Enter Agency name" autocomplete="off" class="form-control">
                                        </div>
                                         <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea placeholder="Enter Agency Description" name="dsc" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label>Phone <small class="text-muted">(999) 999-9999</small></label>
                                            <input  placeholder="Enter Agency Phone" type="text" name="phone" class="form-control phone-inputmask" id="phone-mask" name="phone" >
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input placeholder="Enter Agency price" name="price" type="text" class="form-control">
                                                <div class="input-group-append"><span class="input-group-text">.00</span></div>
                                            </div>
                                         <div class="form-group">
                                            <label for="inputUserName">Opening Houre:</label>
                                            <input id="inputText3" type="text" name="houre" data-parsley-trigger="change" required="" placeholder="Enter user name" autocomplete="off" class="form-control">
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 pl-0">
                                                <p class="text-right">
                                                    <input name="submit" value="Add Agency" type="submit" class="btn btn-space btn-primary"></input>
...
if(isset($_POST["submit"])){
	...
	$rez = json_decode(post(URL_API,"admin/agency",json_encode($data),"POST",$token));
