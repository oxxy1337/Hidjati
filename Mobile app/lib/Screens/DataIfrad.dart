...
List<TodoObject> todos = [
  TodoObject.import("SOME_RANDOM_UUID", "قبل الثامن من ذي الحجة", 1, ColorChoices.choices[0],  {    DateTime(2018, 5, 3): [
  ...
  TodoObject.import("الثامن من ذي الحجة", "الثامن من ذي الحجة", 2, ColorChoices.choices[1],  {
    DateTime(2018, 5, 3): [
      ...
      TaskObject("ينطلق إلى منى بعد صلاة الفجر يصلي بها ( الظهر – العصر – المغرب – العشاء – وفجر اليوم التاسع)"),
    ],
  ...
  TodoObject.import("العاشر من ذي الحجة", "العاشر من ذي الحجة", 4, ColorChoices.choices[0],  {
    DateTime(2018, 5, 3): [
      ...
      TaskObject("السعي إن لم يسعى بعد طواف القدوم"),
